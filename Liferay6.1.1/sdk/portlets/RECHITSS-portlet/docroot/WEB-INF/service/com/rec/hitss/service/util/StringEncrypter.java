...
public class StringEncrypter {
	private static Log _log = LogFactoryUtil.getLog(StringEncrypter.class);
    ...
    StringEncrypter(SecretKey key, String algorithm) {
        try {
            ...
            _log.error("EXCEPTION: NoSuchPaddingException",e);
        } catch (NoSuchAlgorithmException e) {
            _log.error("EXCEPTION: NoSuchAlgorithmException",e);
        } catch (InvalidKeyException e) {
            _log.error("EXCEPTION: InvalidKeyException",e);
        }
    }
    ...
    StringEncrypter(String passPhrase) {
        ...
        try {
            ...
            _log.error("EXCEPTION: InvalidAlgorithmParameterException",e);
        } catch (InvalidKeySpecException e) {
            _log.error("EXCEPTION: InvalidKeySpecException",e);
        } catch (NoSuchPaddingException e) {
            _log.error("EXCEPTION: NoSuchPaddingException",e);
        } catch (NoSuchAlgorithmException e) {
            _log.error("EXCEPTION: NoSuchAlgorithmException",e);
    ...
    public static void testUsingSecretKey() {
        try {
            ...
            _log.info("+----------------------------------------+");
            _log.info("|  -- Test Using Secret Key Method --    |");
            _log.info("+----------------------------------------+");
            ...
            // Print out values
            _log.info(desKey.getAlgorithm() + " Encryption algorithm");
            _log.info("    Original String  : " + secretString);
            _log.info("    Encrypted String : " + desEncrypted);
            _log.info("    Decrypted String : " + desDecrypted);
            

            _log.info(blowfishKey.getAlgorithm() + " Encryption algorithm");
            _log.info("    Original String  : " + secretString);
            _log.info("    Encrypted String : " + blowfishEncrypted);
            _log.info("    Decrypted String : " + blowfishDecrypted);
            

            _log.info(desedeKey.getAlgorithm() + " Encryption algorithm");
            _log.info("    Original String  : " + secretString);
            _log.info("    Encrypted String : " + desedeEncrypted);
            _log.info("    Decrypted String : " + desedeDecrypted);
    ...
    public static void testUsingPassPhrase() {
        ...
        _log.info("+----------------------------------------+");
        _log.info("|  -- Test Using Pass Phrase Method --   |");
        _log.info("+----------------------------------------+");
        ...
        // Print out values
        _log.info("PBEWithMD5AndDES Encryption algorithm");
        _log.info("    Original String  : " + secretString);
        _log.info("    Encrypted String : " + desEncrypted);
        _log.info("    Decrypted String : " + desDecrypted);
