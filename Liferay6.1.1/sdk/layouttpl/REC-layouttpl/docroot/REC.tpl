<div class="REC" id="main-content" role="main">
	...
	<div class="portlet-layout">
		<div
			class="aui-w100 portlet-column col-xs-12 col-sm-12 col-md-12 col-lg-12"
	...
	<div class="portlet-layout">
		<div
			class="aui-w30 portlet-column col-xs-12 col-sm-12 col-md-4 col-lg-4 "
			id="column-2">$processor.processColumn("column-2",
			"portlet-column-content portlet-column-content-first")</div>

		<div
			class="aui-w70 portlet-column col-xs-12 col-sm-12 col-md-8 col-lg-8"
