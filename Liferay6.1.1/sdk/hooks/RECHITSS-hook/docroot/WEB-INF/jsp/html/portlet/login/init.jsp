...
<%
 ...
 PortletConfig portletConfig2 = (PortletConfig)request.getAttribute(JavaConstants.JAVAX_PORTLET_CONFIG);

 SessionMessages.add(request, ((LiferayPortletConfig)portletConfig2).getPortletId() + SessionMessages.KEY_SUFFIX_HIDE_DEFAULT_ERROR_MESSAGE);
