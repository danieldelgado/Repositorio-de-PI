...
<input id="registrar_usuario_portlet" name="" type="hidden"
...
<portlet:resourceURL var="validarUsuarioPostulante"
	id="validarUsuarioPostulante">
	<portlet:param name="" value=""></portlet:param>
</portlet:resourceURL>

<input id="<portlet:namespace/>validarUsuarioPostulante"
	name="<portlet:namespace/>validarUsuarioPostulante" type="hidden"
	value="${validarUsuarioPostulante}" />
<input id="<portlet:namespace/>registrarUsuario"
	name="<portlet:namespace/>registrarUsuario" type="hidden"
		...
		<form id="<portlet:namespace/>fromregistrarUsuario"
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control"
							id="<portlet:namespace/>nombre_usuario"
							name="<portlet:namespace/>nombre_usuario"
							placeholder="<%=PortletProps.get("form.nombre.usuario")%>"
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control"
							id="<portlet:namespace/>apellidos"
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control"
							id="<portlet:namespace/>correo" name="<portlet:namespace/>correo"
							placeholder="<%=PortletProps.get("form.correo")%>"
							value="daniel1234_14@hotmail.com">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control"
							id="<portlet:namespace/>puestoactual"
							name="<portlet:namespace/>puestoactual"
							placeholder="<%=PortletProps.get("form.puesto.actual")%>"
					...
					<div class="col-lg-10">
						<div class="radio">
							<label> <input type="radio"
								name="<portlet:namespace/>genero"
								id="<portlet:namespace/>optionsRadios1"
								value="<%=PortletProps.get("form.genero.femenino.value")%>" />
								<%=PortletProps.get("form.genero.femenino")%>
							</label>
						</div>
						<div class="radio">
							<label> <input type="radio"
								...
								value="<%=PortletProps.get("form.genero.masculino.value")%>"
								checked="checked"> <%=PortletProps.get("form.genero.masculino")%>
							</label>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="text" class="form-control"
							id="<portlet:namespace/>dni" name="<portlet:namespace/>dni"
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
							...
							<input type="text" id="<portlet:namespace/>fechanacimiento" class="" data-format="DD-MM-YYYY"
								data-template="D MMM YYYY" name="<portlet:namespace/>fechanacimiento" value="09-01-1985">
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<input type="password" class="form-control"
							id="<portlet:namespace/>password2"
							name="<portlet:namespace/>password2"
							placeholder="<%=PortletProps.get("form.password.res")%>"
							value="1234">
					</div>
				</div>
				<div class="form-group modal-footer">
					<div class="col-xs-12 col-lg-10 col-lg-offset-2">
						<button id="<portlet:namespace/>btnGuardar" type="button"
							class="btn btn-primary"><%=PortletProps.get("form.label.inscribir")%></button>
					</div>
				</div>
			</fieldset>
		</form>
