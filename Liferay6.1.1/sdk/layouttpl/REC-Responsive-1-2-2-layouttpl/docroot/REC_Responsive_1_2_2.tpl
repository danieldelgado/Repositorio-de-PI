<div class="REC_Responsive_1_2_2" id="main-content" role="main">
		...
		<div class="portlet-layout row">
			<div class="aui-w30 portlet-column col-xs-12 col-sm-12 col-md-5 col-lg-4" id="column-2">
				$processor.processColumn("column-2", "portlet-column-content portlet-column-content-first")
			</div>

			<div class="aui-w70 portlet-column col-xs-12 col-sm-12 col-md-7 col-lg-8" id="column-3">
				$processor.processColumn("column-3", "portlet-column-content portlet-column-content-last")
			</div>
		</div>

		<div class="portlet-layout row">
			<div class="aui-w50 portlet-column col-xs-12 col-sm-12 col-md-5 col-lg-4" id="column-4">
				$processor.processColumn("column-4", "portlet-column-content portlet-column-content-first")
			</div>

			<div class="aui-w50 portlet-column col-xs-12 col-sm-12 col-md-7 col-lg-8" id="column-5">
				$processor.processColumn("column-5", "portlet-column-content portlet-column-content-last")
			</div>
		</div>
	#end
