 ...
 *
 */
public class PortalLogin extends MVCPortlet{
	...
	public void customlogin(ActionRequest actionRequest,
		...
		try {
			...
			long userId= -1;
			userId=	getAuthenticatedUserId( PortalUtil.getHttpServletRequest(actionRequest), login, password);
	...
	private static Log _log = LogFactoryUtil.getLog(PortalLogin.class);
