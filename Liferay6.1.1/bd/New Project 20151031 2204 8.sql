...
INSERT INTO `assetentry` (`entryId`,`groupId`,`companyId`,`userId`,`userName`,`createDate`,`modifiedDate`,`classNameId`,`classPK`,`classUuid`,`classTypeId`,`visible`,`startDate`,`endDate`,`publishDate`,`expirationDate`,`mimeType`,`title`,`description`,`summary`,`url`,`layoutUuid`,`height`,`width`,`priority`,`viewCount`) VALUES 
 ...
 (12168,10180,10154,10196,'Admin Admin','2015-10-30 20:24:06','2015-10-30 22:11:51',10010,12166,'7bbde696-ab10-4f6e-9c03-0547e2238fb1',0,1,NULL,NULL,NULL,NULL,'image/jpeg','meeting_09.jpg','','','','',0,0,0,11),
 ...
 (12177,10180,10154,10196,'Admin Admin','2015-10-30 20:24:07','2015-10-30 22:11:50',10010,12175,'40f97854-2859-466e-81c1-786cc13df97d',0,1,NULL,NULL,NULL,NULL,'image/jpeg','business silhouettes-150-01.jpg','','','','',0,0,0,12),
 ...
 (12187,10180,10154,10196,'Admin Admin','2015-10-30 20:24:09','2015-10-30 22:11:50',10010,12185,'18393980-4f07-48b1-8e4b-9a5e44b0b05a',0,1,NULL,NULL,NULL,NULL,'image/jpeg','04 150p-01.jpg','','','','',0,0,0,10),
...
INSERT INTO `counter` (`name`,`currentId`) VALUES 
 ('com.liferay.counter.model.Counter',12500),
...
INSERT INTO `dlfileentry` (`uuid_`,`fileEntryId`,`groupId`,`companyId`,`userId`,`userName`,`versionUserId`,`versionUserName`,`createDate`,`modifiedDate`,`repositoryId`,`folderId`,`name`,`extension`,`mimeType`,`title`,`description`,`extraSettings`,`fileEntryTypeId`,`version`,`size_`,`readCount`,`smallImageId`,`largeImageId`,`custom1ImageId`,`custom2ImageId`) VALUES 
 ...
 ('7bbde696-ab10-4f6e-9c03-0547e2238fb1',12166,10180,10154,10196,'Admin Admin',10196,'Admin Admin','2015-10-30 20:24:06','2015-10-30 20:24:06',10180,12153,'602','jpg','image/jpeg','meeting_09.jpg','','',0,'1.0',333339,11,0,0,0,0),
 ('40f97854-2859-466e-81c1-786cc13df97d',12175,10180,10154,10196,'Admin Admin',10196,'Admin Admin','2015-10-30 20:24:06','2015-10-30 20:24:06',10180,12153,'603','jpg','image/jpeg','business silhouettes-150-01.jpg','','',0,'1.0',334178,12,0,0,0,0),
 ('18393980-4f07-48b1-8e4b-9a5e44b0b05a',12185,10180,10154,10196,'Admin Admin',10196,'Admin Admin','2015-10-30 20:24:09','2015-10-30 20:59:29',10180,12153,'604','jpg','image/jpeg','04 150p-01.jpg','','',0,'1.1',240267,8,0,0,0,0);
...
INSERT INTO `dlfilerank` (`fileRankId`,`groupId`,`companyId`,`userId`,`createDate`,`fileEntryId`) VALUES 
 ...
 (12286,10180,10154,10158,'2015-11-01 02:09:35',12166),
 (12287,10180,10154,10158,'2015-11-01 02:09:35',12175),
 (12288,10180,10154,10158,'2015-11-01 02:09:35',12185);
...
INSERT INTO `release_` (`releaseId`,`createDate`,`modifiedDate`,`servletContextName`,`buildNumber`,`buildDate`,`verified`,`state_`,`testString`) VALUES 
 (1,'2015-10-16 17:51:25','2015-11-01 02:06:20','portal',6101,'2015-11-01 02:06:20',1,0,'You take the blue pill, the story ends, you wake up in your bed and believe whatever you want to believe. You take the red pill, you stay in Wonderland, and I show you how deep the rabbit hole goes.');
...
INSERT INTO `user_` (`uuid_`,`userId`,`companyId`,`createDate`,`modifiedDate`,`defaultUser`,`contactId`,`password_`,`passwordEncrypted`,`passwordReset`,`passwordModifiedDate`,`digest`,`reminderQueryQuestion`,`reminderQueryAnswer`,`graceLoginCount`,`screenName`,`emailAddress`,`facebookId`,`openId`,`portraitId`,`languageId`,`timeZoneId`,`greeting`,`comments`,`firstName`,`middleName`,`lastName`,`jobTitle`,`loginDate`,`loginIP`,`lastLoginDate`,`lastLoginIP`,`lastFailedLoginDate`,`failedLoginAttempts`,`lockout`,`lockoutDate`,`agreedToTermsOfUse`,`emailAddressVerified`,`status`) VALUES 
 ...
 ('2bbf03e9-0788-4d9e-8ae1-03ee6f00956d',10196,10154,'2015-10-17 00:53:25','2015-10-28 20:37:58',0,10197,'qUqP5cyxm6YcTAhz05Hph5gvu9M=',1,0,'2015-10-17 00:59:30','e5d86c6f3672e52795891c3597f20de0,751da756639bc033b572ba2e7849b589,8f3d267131c99bf7ba6ade3481d748b4','','',0,'test','test@liferay.com',0,'',0,'es_ES','Pacific/Midway','Bienvenido  Aadmin Admin!','','Admin','','Admin','','2015-11-01 02:09:09','127.0.0.1','2015-10-31 19:02:11','127.0.0.1',NULL,0,0,NULL,0,1,0);
...
--
-- Create schema recportal
--

CREATE DATABASE IF NOT EXISTS recportal;
USE recportal;

--
-- Definition of table `solicitudreclutamiento`
--

DROP TABLE IF EXISTS `solicitudreclutamiento`;
CREATE TABLE `solicitudreclutamiento` (
  `solicitudReclutamientoId` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `puesto` varchar(45) NOT NULL,
  PRIMARY KEY (`solicitudReclutamientoId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `solicitudreclutamiento`
--

/*!40000 ALTER TABLE `solicitudreclutamiento` DISABLE KEYS */;
/*!40000 ALTER TABLE `solicitudreclutamiento` ENABLE KEYS */;
