	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button  type="button" class="close closelogin" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<c:choose>
					...
					<c:otherwise>
						...
						<aui:form action="<%=loginURL%>"
							...
							method="post" name="fm" cssClass="form center-block">
							...
							<c:choose>
								...
								<c:when
									...
									<div class="portlet-msg-success">
										...
										"thank-you-for-creating-an-account.-you-will-be-notified-via-email-at-x-when-your-account-has-been-approved", userEmailAddress)%>
									</div>
								</c:when>
							</c:choose>
							...
							<aui:fieldset>
								...
								<aui:input name="login" label="" showRequiredLabel="<%=false%>"
									type="text" value="<%=login%>"
									inputCssClass="aui-field-input aui-field-input-text user_txt form-control input-lg"
									labelCssClass="aui-field-label" placeholder="Correo">
									<aui:validator name="required" />
								</aui:input>

								<aui:input name="password" showRequiredLabel="<%=false%>"
									type="password" value="<%=password%>" label=""
									inputCssClass="aui-field-input aui-field-input-text user_txt form-control input-lg"
									labelCssClass="aui-field-label" placeholder="Password">
									<aui:validator name="required" />
							...
							<div class="form-group">
								<aui:button-row>
									<aui:button type="submit" value="sign-in"
										inputCssClass="btn btn-primary btn-lg btn-block" />
								</aui:button-row>
							</div>
